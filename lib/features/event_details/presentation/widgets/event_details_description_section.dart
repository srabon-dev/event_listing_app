...
class EventDetailsDescriptionSection extends StatelessWidget {
  const EventDetailsDescriptionSection({super.key, required this.data, required this.isUser, required this.id, required this.controller});
  final String id;
  ...
  Widget build(BuildContext context) {
    return data.description != null && data.description!.isNotEmpty ? Column(
            ...
            children: [
              ...
              if (isUser && data.ratingData?.user?.id == null)
